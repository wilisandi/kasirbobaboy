...
public class login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if ((inpUsername.getText().equals("kasir")) && (inpPassword.getText().equals("kasir123"))) {
            ...
            JOptionPane.showMessageDialog(this, "Username dan Password tidak sesuai, silahkan cek kembali",
                    "Konfirm Password", JOptionPane.ERROR_MESSAGE);
        }
